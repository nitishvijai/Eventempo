...
namespace Eventempo.View
{
    ...
    public sealed partial class EditEvent : Page
    {
        ...
        public EditEvent(string name, string description, DateTime time, Color color)
        {
            ...
            HexEventColorPicker.Color = color;
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            HexEventColorPicker.Color = eventParam.EventColor.Color;
        ...
        public void ValidateFields()
        {
            ...
            if (EventNameBox.Text != _name || EventDescBox.Text != _description || EventTimePicker.Time != _time || EventDatePicker.Date != _date || HexEventColorPicker.Color != _color)
            {
                changesMade = true;
            }
            else
            ...
            if (EventNameBox.Text != "" && EventDatePicker.Date != null && EventDescBox.Text != "" && EventTimePicker.SelectedTime != null && HexEventColorPicker.Color != null)
            {
        ...
        public async Task WriteToFile()
        {
            DateTime final = CombineDateAndTime((EventDatePicker.Date.Value).DateTime, new DateTime().Add(EventTimePicker.Time));
            string fileText = "";
            string text = EventNameBox.Text + "-!#1#!-" + EventDescBox.Text + "-!#2#!-" + final.ToString("MM/dd/yyyy HH:mm") + "-!#3#!-" + HexEventColorPicker.Color.ToString();
