...
namespace Eventempo.View
{
    ...
    public sealed partial class EventView : Page
    {
        ...
        {
            backColor = (Color)this.Resources["SystemAccentColor"];
            buttonColor = (Color)titleBar.ButtonBackgroundColor;
            titleBar.BackgroundColor = currEvent.EventColor.Color;
            titleBar.ButtonBackgroundColor = currEvent.EventColor.Color;
            if (((currEvent.EventColor.Color.R * 0.299 + currEvent.EventColor.Color.G * 0.587 + currEvent.EventColor.Color.B * 0.114) / 255) > 0.5)
            {
                titleBar.ForegroundColor = Windows.UI.Colors.Black;
                titleBar.ButtonForegroundColor = Windows.UI.Colors.Black;
            }
        ...
        private bool On_BackRequested()
        {
            if (this.Frame.CanGoBack)
            {
                ...
                titleBar.ButtonBackgroundColor = buttonColor;
                if (((backColor.R * 0.299 + backColor.G * 0.587 + backColor.B * 0.114) / 255) > 0.5)
                {
                    titleBar.ForegroundColor = Windows.UI.Colors.Black;
                    titleBar.ButtonForegroundColor = Windows.UI.Colors.Black;
                }
